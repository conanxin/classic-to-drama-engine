...
VERIFY=(ROOT/'visual-development/odyssey_m1_p4/P4_INDEPENDENT_VERIFICATION.json').resolve()
EXCLUDE={OUT.resolve(),VERIFY,(ROOT/'ODYSSEY_P4_FINAL_RESULT.md').resolve()}
...
def main()->None:
    ...
    doc={"artifact_class":"odyssey_p4_artifact_manifest","schema_version":"1.0.0","baseline_commit":"0c4a403864d9ea89afabceed3c7be7d5819f86c8","artifact_count":len(entries),"entry_payload_sha256":hashlib.sha256(payload).hexdigest(),"entries":entries,"exclusions":["visual-development/odyssey_m1_p4/P4_ARTIFACT_MANIFEST.json (self)","visual-development/odyssey_m1_p4/P4_INDEPENDENT_VERIFICATION.json (verifier output over frozen payload)","ODYSSEY_P4_FINAL_RESULT.md (final verification record; persistence commit recovered from git)"],"status":"FROZEN_P4_CONTENT_PAYLOAD"}
